...
schema_get_file_content = types.FunctionDeclaration(
    ...
    description="Read contents of the specified file into a string, constrained to the working directory.",
    parameters=types.Schema(
        type=types.Type.OBJECT,
        properties={
...
schema_run_python_file = types.FunctionDeclaration(
    ...
    parameters=types.Schema(
        ...
        properties={
            "file_path": types.Schema(
                type=types.Type.STRING,
                description="The Pythno file path to execute, relative to the working directory.",
            ),
        },
    ),
)
